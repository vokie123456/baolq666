...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('static/admin/static/h-ui.admin/css/H-ui.login.css') }}" />
        ...
        <form class="form form-horizontal" action="" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8">
                    <input id="username" name="username" type="text" placeholder="OA账户" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
<div class="footer">Copyright baolq666 </div>

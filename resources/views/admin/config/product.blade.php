...
@section('main_content')
    ...
    <nav class="breadcrumb">
        ...
        产品列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
    </nav>
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="javascript:;" onclick="app_add('添加产品','/admin/product/add','','510')" class="btn btn-primary radius">
            ...
            <table class="table table-border table-bordered table-hover table-bg table-sort">
                ...
                @foreach( $pages as $row)
                    <tr class="text-c">
                        ...
                        <td>{{ $row->des }}</td>
                        <td>{{ $row->min_quota }}~{{ $row->max_quota }}</td>
                        ...
                        <td>
                            <a title="编辑" href="javascript:;" onclick="app_edit('编辑产品','/admin/product/update/{{ $row->id }}','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>

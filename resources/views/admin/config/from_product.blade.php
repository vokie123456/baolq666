        ...
        <form action="" method="post" class="form form-horizontal" id="form-resource-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="text" class="input-text" value="{{ $info->min_quota or '' }}" placeholder="最小额度" id="min_quota" name="min_quota">
                </div>
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="text" class="input-text" value="{{ $info->max_quota or '' }}" placeholder="最大额度" id="max_quota" name="max_quota">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>日利率：</label>
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="text" class="input-text" value="{{ $info->profit_ratio or '' }}" placeholder="百分比" id="profit_ratio" name="profit_ratio">
                </div>
            </div>
            <div class="row cl">
